...
mod tests {
    ...
    #[test]
    fn test_parse_line() {
        assert_eq!(parse_line("+1"), Ok(1));
        assert_eq!(parse_line("-1"), Ok(-1));
        assert_eq!(parse_line("+5"), Ok(5));
        assert_eq!(parse_line("+500"), Ok(500));
        assert_eq!(parse_line(""), Err(Error::TooShort));
        assert_eq!(parse_line("100"), Err(Error::MissingSign));
        assert_eq!(parse_line("+fail"), Err(Error::BadNumber));
    }
